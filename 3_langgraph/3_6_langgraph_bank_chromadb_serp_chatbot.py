# pip install langgraph langchain-community langchain-huggingface langchain-openai chromadb gradio requests
...
def banking_faq_search(state: ChatState) -> ChatState:
    ...
    if similarity >= 0.65:
        state["answer"] = doc.metadata["Response"]
...
demo = gr.ChatInterface(
    fn=chat_fn,
    title="Banking Chatbot (Vector DB + SERP Fallback)",
    examples=[
